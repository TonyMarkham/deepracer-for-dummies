...
I am running Ubuntu off of a 128GB Partition of my primary SSD that is shared with Windows.  Additionally, I installed a 2TB Drive specifically to handle the data generated by training my AWS DeepRacer.
